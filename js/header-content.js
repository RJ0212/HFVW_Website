/**
 * Header Content - Reusable header HTML from components/header.html
 * This file contains the header HTML that is injected into all pages
 */

const HEADER_HTML = `<!-- Header Component -->
<header class="header">
  <!-- Top Bar -->
    ...
    <div class="header-top-content">
      <div style="display: flex; align-items: center; gap: 1rem;">
        ...
        <span style="display: flex; align-items: center; gap: 0.25rem;">
          ...
          hopeforventwarriors@gmail.com
        </span>
      </div>
      <span class="header-top-tagline">Every Breath Matters 💙</span>
    </div>
  </div>
  ...
  <nav class="header-nav">
    <a href="index.html" class="header-logo">
      <div class="header-logo-icon">
        <img src="assets/HFVW_Logo.png" alt="Hope For Vent Warriors Logo" style="width: 100%; height: 100%; object-fit: contain;">
      </div>
      <div class="header-logo-text">
        <span class="header-logo-title">Hope For Vent Warriors</span>
        <span class="header-logo-subtitle">Charity Group · Philippines</span>
      </div>
    </a>
